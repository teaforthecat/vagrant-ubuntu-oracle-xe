...
-- Evolution
CREATE USER EVOLUTION_DEV IDENTIFIED BY abcd1234 DEFAULT TABLESPACE USERS TEMPORARY TABLESPACE TEMP;
GRANT AQ_ADMINISTRATOR_ROLE,AQ_USER_ROLE,APP_DBO TO EVOLUTION_DEV ;
ALTER USER EVOLUTION_DEV DEFAULT ROLE AQ_ADMINISTRATOR_ROLE,AQ_USER_ROLE,APP_DBO;
ALTER USER EVOLUTION_DEV QUOTA UNLIMITED ON EVOLUTION_CLOB;
ALTER USER EVOLUTION_DEV QUOTA UNLIMITED ON EVOLUTION_DATA;
ALTER USER EVOLUTION_DEV QUOTA 10240K ON USERS;
ALTER USER EVOLUTION_DEV QUOTA UNLIMITED ON EVOLUTION_INDEX;
ALTER USER EVOLUTION_DEV QUOTA UNLIMITED ON EVOLUTION_XML;
GRANT EXECUTE ON SYS.DBMS_AQ TO EVOLUTION_DEV;

-- Evolution test user
CREATE USER EVOLUTION_TEST IDENTIFIED BY abcd1234 DEFAULT TABLESPACE USERS TEMPORARY TABLESPACE TEMP;
GRANT AQ_ADMINISTRATOR_ROLE,AQ_USER_ROLE,APP_DBO TO EVOLUTION_TEST ;
ALTER USER EVOLUTION_TEST DEFAULT ROLE AQ_ADMINISTRATOR_ROLE,AQ_USER_ROLE,APP_DBO;
ALTER USER EVOLUTION_TEST QUOTA UNLIMITED ON EVOLUTION_CLOB;
ALTER USER EVOLUTION_TEST QUOTA UNLIMITED ON EVOLUTION_DATA;
ALTER USER EVOLUTION_TEST QUOTA 10240K ON USERS;
ALTER USER EVOLUTION_TEST QUOTA UNLIMITED ON EVOLUTION_INDEX;
ALTER USER EVOLUTION_TEST QUOTA UNLIMITED ON EVOLUTION_XML;
...
-- XACT
CREATE USER XACT_DEV IDENTIFIED BY abcd1234 DEFAULT TABLESPACE USERS TEMPORARY TABLESPACE TEMP;
GRANT APP_DBO TO XACT_DEV ;
ALTER USER XACT_DEV DEFAULT ROLE APP_DBO;
ALTER USER XACT_DEV QUOTA UNLIMITED ON TSMS_DATA01;
ALTER USER XACT_DEV QUOTA UNLIMITED ON TSMS_CLOB01;
ALTER USER XACT_DEV QUOTA 10240K ON USERS;
ALTER USER XACT_DEV QUOTA UNLIMITED ON TSMS_INDX01;

-- XACT test user
CREATE USER XACT_TEST IDENTIFIED BY abcd1234 DEFAULT TABLESPACE USERS TEMPORARY TABLESPACE TEMP;
GRANT APP_DBO TO XACT_TEST ;
ALTER USER XACT_TEST DEFAULT ROLE APP_DBO;
ALTER USER XACT_TEST QUOTA UNLIMITED ON TSMS_DATA01;
ALTER USER XACT_TEST QUOTA UNLIMITED ON TSMS_CLOB01;
ALTER USER XACT_TEST QUOTA 10240K ON USERS;
ALTER USER XACT_TEST QUOTA UNLIMITED ON TSMS_INDX01;
